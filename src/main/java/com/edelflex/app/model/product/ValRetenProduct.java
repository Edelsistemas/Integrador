...
@NoArgsConstructor
@SuperBuilder
public class ValRetenProduct extends Product {
  ...
  private String conexiones; // U_SEI_Conex
  ...
  public static ValRetenProduct create(ResultSet rs) throws SQLException {
    return ValRetenProduct.builder()
        .id(rs.getLong("id"))
        ...
        .conexiones(rs.getString("Item_Conexiones"))
