...
@NoArgsConstructor
@SuperBuilder
public class ValFuelleProduct extends Product {
  ...
  public static ValFuelleProduct create(ResultSet rs) throws SQLException {
    return ValFuelleProduct.builder()
        .id(rs.getLong("id"))
        ...
        .itemDiametroSupMedio(rs.getString("Item_Diametro cuerpo superior"))
