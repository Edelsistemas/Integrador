...
@NoArgsConstructor
@SuperBuilder
public class SisRecProdProduct extends Product {
  ...
  public static SisRecProdProduct create(ResultSet rs) throws SQLException {
    return SisRecProdProduct.builder()
        .id(rs.getLong("id"))
        .name(rs.getString("Name"))
        .product(rs.getString("Product"))
        .revision(rs.getString("Revision"))
        .codigoEdelflex(rs.getString("Codigo Edelflex"))
       // .codigoProveedor(rs.getString("Item_Codigo Proveedor")) FIXME: CONFIRMAR CAMPO
