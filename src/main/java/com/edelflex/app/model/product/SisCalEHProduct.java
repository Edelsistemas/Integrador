...
@NoArgsConstructor
@SuperBuilder
public class SisCalEHProduct extends Product {
  ...
  public static SisCalEHProduct create(ResultSet rs) throws SQLException {
    return SisCalEHProduct.builder()
        .id(rs.getLong("id"))
        .name(rs.getString("Name"))
        .product(rs.getString("Product"))
        .revision(rs.getString("Revision"))
        .codigoEdelflex(rs.getString("efx4_CodigoEdeflex"))
            //.codigoProveedor(rs.getString("Codigo Proveedor")) FIXME: CONFIRMAR
