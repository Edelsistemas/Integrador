...
@NoArgsConstructor
@SuperBuilder
public class OtrasBomProduct extends Product {
  ...
  public static OtrasBomProduct create(ResultSet rs) throws SQLException {
    return OtrasBomProduct.builder()
        .id(rs.getLong("id"))
        ...
        .itemTipo(rs.getString("Item_Tipo de bomba")) // FIXME: VALIDAR SI ES ESTE
