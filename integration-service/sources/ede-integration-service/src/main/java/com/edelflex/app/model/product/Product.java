...
public class Product {
  ...
  public Map<String, Object> createRequest() {
    ...
    Map<String, Object> clearedValues = clearEmptyValues(request);
    if (inactivo != null && inactivo) {
      clearedValues.put("Valid", "tNO");
      clearedValues.put("ValidFrom", null);
      clearedValues.put("ValidTo", null);
      clearedValues.put("ValidRemarks", null);
      clearedValues.put("Frozen", "tYES");
      clearedValues.put("FrozenFrom", null);
      clearedValues.put("FrozenTo", null);
      clearedValues.put("FrozenRemarks", null);
    }
